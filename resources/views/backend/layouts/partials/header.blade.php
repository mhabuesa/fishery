        ...
        <div class="d-flex align-items-center">
            <div class="dropdown d-inline-block me-2">
                <button type="button" class="btn btn-sm btn-alt-secondary d-flex align-items-center"
                    ...
                    <span class="d-none d-sm-inline-block ms-2 fw-medium">{{ strtoupper(app()->getLocale()) }}</span>
                    <i class="fa fa-fw fa-angle-down d-none d-sm-inline-block opacity-50 ms-1"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end p-0 border-0"
                    aria-labelledby="page-header-language-dropdown">
                    <div class="p-2">
                        <a class="dropdown-item d-flex align-items-center justify-content-between {{ app()->getLocale() === 'bn' ? 'active' : ''}}"
                            href="{{ route('language.change', 'bn') }}">
                            <span class="fs-sm fw-medium">বাংলা</span>
                            @if (app()->getLocale() === 'bn')
                ...
                <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0"
                    ...
                    <div class="p-2">
                        <a class="dropdown-item d-flex align-items-center justify-content-center"
                            ...
                            <span class="fs-sm fw-bold">{{ __('messages.profile') }}</span>
                        </a>
                    </div>
                    ...
                    <div class="p-2">
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a class="dropdown-item d-flex align-items-center justify-content-center"
                                ...
                                <span class="fs-sm fw-bold text-danger">{{ __('messages.logout') }}</span>
                            </a>
                        </form>
                    </div>
                </div>
